<h1>1272 - Invalid Transactions</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/invalid-transactions/">invalid-transactions</a></h2><p>A transaction is possibly invalid if:</p>

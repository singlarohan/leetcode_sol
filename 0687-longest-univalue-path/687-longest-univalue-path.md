<h1>687 - Longest Univalue Path</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/longest-univalue-path/">longest-univalue-path</a></h2><p>Given the <code>root</code> of a binary tree, return <em>the length of the longest path, where each node in the path has the same value</em>. This path may or may not pass through the root.</p>

<h1>2372 - Rearrange Characters to Make Target String</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/rearrange-characters-to-make-target-string/">rearrange-characters-to-make-target-string</a></h2><p>You are given two <strong>0-indexed</strong> strings <code>s</code> and <code>target</code>. You can take some letters from <code>s</code> and rearrange them to form new strings.</p>

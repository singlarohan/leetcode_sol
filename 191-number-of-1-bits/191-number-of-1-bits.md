<h1>191 - Number of 1 Bits</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/number-of-1-bits/">number-of-1-bits</a></h2><p>Write a function that takes&nbsp;the binary representation of an unsigned integer and returns the number of &#39;1&#39; bits it has (also known as the <a href="http://en.wikipedia.org/wiki/Hamming_weight" target="_blank">Hamming weight</a>).</p>

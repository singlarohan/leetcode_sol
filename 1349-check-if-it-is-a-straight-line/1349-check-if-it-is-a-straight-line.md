<h1>1349 - Check If It Is a Straight Line</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-it-is-a-straight-line/">check-if-it-is-a-straight-line</a></h2><p>You are given an array&nbsp;<code>coordinates</code>, <code>coordinates[i] = [x, y]</code>, where <code>[x, y]</code> represents the coordinate of a point. Check if these points&nbsp;make a straight line in the XY plane.</p>

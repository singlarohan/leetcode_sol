<h1>621 - Task Scheduler</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/task-scheduler/">task-scheduler</a></h2><p>Given a characters array <code>tasks</code>, representing the tasks a CPU needs to do, where each letter represents a different task. Tasks could be done in any order. Each task is done in one unit of time. For each unit of time, the CPU could complete either one task or just be idle.</p>

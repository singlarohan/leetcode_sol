<h1>807 - Custom Sort String</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/custom-sort-string/">custom-sort-string</a></h2><p>You are given two strings order and s. All the characters of <code>order</code> are <strong>unique</strong> and were sorted in some custom order previously.</p>

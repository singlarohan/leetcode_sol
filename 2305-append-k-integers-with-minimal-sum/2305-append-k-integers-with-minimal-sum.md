<h1>2305 - Append K Integers With Minimal Sum</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/append-k-integers-with-minimal-sum/">append-k-integers-with-minimal-sum</a></h2><p>You are given an integer array <code>nums</code> and an integer <code>k</code>. Append <code>k</code> <strong>unique positive</strong> integers that do <strong>not</strong> appear in <code>nums</code> to <code>nums</code> such that the resulting total sum is <strong>minimum</strong>.</p>

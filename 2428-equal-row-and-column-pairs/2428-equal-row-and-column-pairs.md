<h1>2428 - Equal Row and Column Pairs</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/equal-row-and-column-pairs/">equal-row-and-column-pairs</a></h2><p>Given a <strong>0-indexed</strong> <code>n x n</code> integer matrix <code>grid</code>, <em>return the number of pairs </em><code>(r<sub>i</sub>, c<sub>j</sub>)</code><em> such that row </em><code>r<sub>i</sub></code><em> and column </em><code>c<sub>j</sub></code><em> are equal</em>.</p>

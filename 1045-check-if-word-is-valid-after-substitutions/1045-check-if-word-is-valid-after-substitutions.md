<h1>1045 - Check If Word Is Valid After Substitutions</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/check-if-word-is-valid-after-substitutions/">check-if-word-is-valid-after-substitutions</a></h2><p>Given a string <code>s</code>, determine if it is <strong>valid</strong>.</p>

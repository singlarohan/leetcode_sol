<h1>306 - Additive Number</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/additive-number/">additive-number</a></h2><p>An <strong>additive number</strong> is a string whose digits can form an <strong>additive sequence</strong>.</p>

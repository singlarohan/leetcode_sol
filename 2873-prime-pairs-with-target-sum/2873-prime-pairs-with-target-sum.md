<h1>2873 - Prime Pairs With Target Sum</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/prime-pairs-with-target-sum/">prime-pairs-with-target-sum</a></h2><p>You are given an integer <code>n</code>. We say that two integers <code>x</code> and <code>y</code> form a prime number pair if:</p>

<h1>397 - Integer Replacement</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/integer-replacement/">integer-replacement</a></h2><p>Given a positive integer <code>n</code>,&nbsp;you can apply one of the following&nbsp;operations:</p>

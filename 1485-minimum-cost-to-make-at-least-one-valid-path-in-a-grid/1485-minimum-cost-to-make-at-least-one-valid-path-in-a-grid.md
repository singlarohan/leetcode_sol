<h1>1485 - Minimum Cost to Make at Least One Valid Path in a Grid</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid/">minimum-cost-to-make-at-least-one-valid-path-in-a-grid</a></h2><p>Given an <code>m x n</code> grid. Each cell of the grid has a sign pointing to the next cell you should visit if you are currently in this cell. The sign of <code>grid[i][j]</code> can be:</p>
